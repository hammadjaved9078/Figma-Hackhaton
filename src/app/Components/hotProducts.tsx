  ...
  return (
    <header className="container mx-auto px-4 py-12 lg:py-16">
      <div className="relative grid grid-cols-1 gap-8 md:grid-cols-[auto_1fr]">
        {/* Vertical text */}
        <div className="absolute left-[-260px] top-[300px] transform -translate-y-1/2 text-[25px] leading-[40px] text-black font-roboto font-normal uppercase rotate-[-90deg]">
